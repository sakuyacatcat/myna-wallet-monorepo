...
async function main() {
    ...
    // ----Start: Sponsor user operation----
    // If you have a verifying paymaster, you can sponsor the user operation
    userOperation = await sponsorUserOperation(userOperation)
    // ----End: Sponsor user operation----

    // ----Start: Estimate gas----(without sponsor)
    // comment out if you don't have a verifying paymaster
    ...
    // userOperation.verificationGasLimit = estimatedGas.verificationGasLimit
    // ----End: Estimate gas----(without sponsor)
...
// Helper functions
export function createInitCode(identityCommitment: Hex, salt: bigint): Hex {
...
export function generateDummyZKPSignature(): Hex {
